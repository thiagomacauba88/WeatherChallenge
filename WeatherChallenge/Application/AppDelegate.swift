...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        GMSServices.provideAPIKey(URLInfo.url(fromKey: "googleMapsApiKey"))
    ...
    private func configureNavigationBarAppearence() {
        ...
        UINavigationBar.appearance().backgroundColor = UIColor.colorBlueDefault
    ...
    lazy var persistentContainer: NSPersistentCloudKitContainer = {
        ...
        */
        let container = NSPersistentCloudKitContainer(name: "WeatherChallenge")
